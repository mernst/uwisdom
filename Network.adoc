 ...
 * the OS limitations below are shared by other cloud CI infrastructure
 * builds and tests pull requests
...
Travis CI -- Travis does not run the build for that commit.
