...
(Suzanne says that whoever does the squashing becomes the author, so the main author should do this.
Ben says anyone can do this and the original author remains the author.)
To do so:
...
To make someone else the author, do the squash on the command line:
```
git checkout master
