...
Later, you will do
```
git push origin mynamefortheirbranch
```
but that leaves regular "push" sending to the remote, so you should
re-checkout (or find a better sequence of operations that does this!).
