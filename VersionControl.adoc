 ...
 * Now, the repository is correct, but clones/checkouts/enlistments may
   still retain the extraneous commits.  For *every* clone, either delete
   it and re-clone (easiest) or follow the above instructions.
