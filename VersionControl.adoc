...
single commit (https://github.com/blog/2141-squash-your-commits); however, this will
make you the author.  To do so:
 * Click "Merge pull request"
 * Click the down arrow next to "Confirm merge" (See attached image)
