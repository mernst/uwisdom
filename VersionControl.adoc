...
become different (say, there are a lot of extraneous merges in it), hese is
 ...
 * Now, the master branch of the repository is correct (on GitHub and locally), but
   other clones/checkouts/enlistments may still retain the extraneous commits.
   For *every* clone on every machine, either:
    * delete it and re-clone (easiest), or
