...
```
  gitlab-ci-multi-runner register --config=/etc/gitlab-runner/config.toml --url=https://gitlab.cs.washington.edu/ci --token=<runners token from your project's runners page> 
```
To unregister it:
```
