...
----
  J2SE 17.0 = 61 (0x3d hex)   [to be released September 2021; likely LTS version]
  J2SE 16.0 = 60 (0x3c hex)   [to be released March 2021]
...
To obtain the classpath at run time, on JDK 8 or JDK 11:
```
dependencies {
