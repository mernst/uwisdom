...
Since Gradle always passes the -d command-line argument, any doclet
intended for running on JDK 9+ should support the `-d` command-line
argument, even if it ignores it.
