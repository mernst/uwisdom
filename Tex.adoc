...
To change the font and line spacing for LaTeX figure captions in acmart.cls, do:
```
% Change font and line spacing fro figure captions
...
For a single-colum, double-spaced version of an ACM paper, for review:
```
